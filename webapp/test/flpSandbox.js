		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#empsocialempreportapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"empsocialempreportapplication-display": {
								"semanticObject": "empsocialempreportapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=emp.social.empreportapplication",
									"url": sap.ui.require.toUrl("emp/social/empreportapplication")
								}
							}
						}
					}
